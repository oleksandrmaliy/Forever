...
const ForeverBlock = () => {
  return (
    <div className="mx-8 mb-8 grid grid-cols-4 gap-8 border-4 border-red-500 bg-sky-100 p-8">
      ...
      <div className="col-span-3">
        <p className="mb-4">
          <b>
            Forever Living Products – міжнародний лідер у виробництві продукції
            на основі алое вера
          </b>
        </p>
        <p className="mb-4">
          Forever Living Products – це американська компанія, заснована у 1978
          році в місті Скоттсдейл, штат Аризона. Вона спеціалізується на
          вирощуванні, виробництві та дистрибуції продуктів на основі алое вера,
          а також пропонує широкий асортимент харчових добавок, засобів догляду
          за шкірою та іншої продукції для здоров’я.
        </p>
        <p>
        ...
        <ul className="mb-4">
          ...
          <li> 🍯 Продукти бджільництва – мед, маточне молочко, прополіс. </li>
          <li>
            💊 Харчові добавки – вітаміни та мінерали для підтримки організму.
          </li>
          <li>
          ...
          <li>
            🏋️ Програми детоксу та контролю ваги – комплексні рішення для
            здорового способу життя.
          </li>
        </ul>
        <p className="mb-4">
          Бізнес-модель та принципи Forever Living Products працює за моделлю
          мережевого маркетингу (MLM), що дозволяє незалежним дистриб’юторам
          розвивати власний бізнес, продаючи продукцію компанії.
        </p>
        <p>
        ...
        <p className="mb-4">
          Forever Living Products залишається одним із найбільших виробників
          продукції на основі алое вера у світі, пропонуючи натуральні та
          ефективні рішення для здорового способу життя. 🌱💚
        </p>
